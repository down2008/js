...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://meg-lodon-session-1.onrender.com/code?number=${q}`);
        ...
        const doneMessage = "> *ᴍᴇɢᴀʟᴏᴅᴏɴ-ᴍᴅ ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ*";

        // Send first message
        await reply(`${doneMessage}\n\n> *𝐏𝐀𝐈𝐑𝐈𝐍𝐆 𝐂𝐎𝐃𝐄 𝐈𝐒: ${pairingCode}*`);
